...
select  FIRST_NAME, avg(salary) from worker group by FIRST_NAME
having avg(salary)>100000;
select LAST_NAME ,avg(salary) from worker group by LAST_NAME having avg(salary) BETWEEN 50000 AND  200000; 
